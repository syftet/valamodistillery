...
role :app, %w{ubuntu@34.244.6.90}, my_property: :my_value
role :web, %w{ubuntu@34.244.6.90}, other_property: :other_value
role :db,  %w{ubuntu@34.244.6.90}

server '34.244.6.90', user: 'ubuntu', roles: %w{web app}
