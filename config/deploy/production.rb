...
role :app, %w{ubuntu@34.249.191.150}, my_property: :my_value
role :web, %w{ubuntu@34.249.191.150}, other_property: :other_value
role :db,  %w{ubuntu@34.249.191.150}

server '34.249.191.150', user: 'ubuntu', roles: %w{web app}
